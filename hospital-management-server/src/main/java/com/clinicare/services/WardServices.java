...
import static com.clinicare.dtos.WardDataBackinBean.createWard;
import static com.clinicare.dtos.WardDataBackinBean.createWardsList;
...
public class WardServices {
	...
	public int addWard(WardDataBackinBean ward) {
		return wardDao.insertIntoWardTable(0, ward.getType(), ward.getCharges(), ward.getMaxCapacity(),
				ward.getMaxCapacity());
